...
namespace SCE.Web.Models
{
    public class StarsViewModel
    {
        ...
        public static List<StarsViewModel> getData()
        {
            ...
            var starsListByCat = new List<StarsViewModel>();
            starsListByCat.Add(new StarsViewModel("Praposal Rank", "5", "4", "3", "2", "1"));
            ...
            starsListByCat.Add(new StarsViewModel("Total Rank", "15", "12", "9", "6", "3"));
            starsListByCat.Add(new StarsViewModel("Total Star Rank", "15", "12 - 14", "9 - 11", "6 - 8", "3 - 5"));
            return starsListByCat;
        }
    }
}